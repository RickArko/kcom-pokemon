"""Inference from a saved ensemble for Pokemon TCG AI Battle Challenge Strategy.

Usage:
    uv run python scripts/predict.py --run-dir outputs/runs/20260625_143042_experiment-name
...
def main() -> None:
    ...
    save_submission(test["id"], test_preds, output_path, target_col=target_col)
    logger.info("Done!")
