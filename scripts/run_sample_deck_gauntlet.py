...
# --- The 4 official sample decks (card ID lists) -----------------------------
# Mega Abomasnow ex is the verbatim sample_submission deck; the other three are
# reconstructed from the designated card list using the same support package.
