...
class StackingEnsemble:
    ...
    def fit(
        ...
        for fold, (train_idx, val_idx) in enumerate(cv.split(X, y_enc)):
            ...
            score = accuracy_score(y_val, fold_preds_enc)
        ...
        self.overall_oof_score_ = accuracy_score(y_enc, oof_final_enc)
    ...
    def predict(self, X: pd.DataFrame) -> np.ndarray:
        ...
        Returns
        -------
        1-D array of class labels (decoded from label encoding).
        """
        n = len(X)
